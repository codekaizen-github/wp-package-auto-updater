<?php
/**
 * CachingCheckUpdatePackageMetaValueServiceFactory
 *
 ...
 * Undocumented class
 */
class CachingCheckUpdatePackageMetaValueServiceFactory implements CheckUpdatePackageMetaValueServiceFactoryContract {
	/**
	...
	public function create(): CheckUpdatePackageMetaValueServiceContract {
		return new CachingCheckUpdatePackageMetaValueService(
			new StandardCheckUpdatePackageMetaValueService(
				$this->accessor,
				$this->fullSlug,
				$this->logger
			)
